      ...
      <form>
        <div className="pt-10 text-base flex flex-col">
          <div className="flex gap-x-[20px] mb-3 flex-col">
                  ...
                  {!imagePreview && (
                    <div>
                      <svg
                        ...
                        stroke-width="2"
                        stroke="currentColor"
                        className="w-10 h-10 text-gray-600 mx-auto mb-4"
                      >
                        <path
                      ...
                      <p className="mt-2 text-gray-700 text-center">
                        {" "}
                        เพิ่มรูปโครงการ รูปควรอยู่ในไฟล์ <b className="text-gray-500"> JPG, PNG, or GIF</b>
                      </p>
                    </div>
                  )}
                </div>
            ...
            {/* SDGs */}
            <div
              className="bg-white p-4 rounded-md w-full text-center mt-2 hover:scale-[1.02] transition duration-200 hover:bg-gray-200"
