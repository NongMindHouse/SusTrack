      ...
      <section className="w-full bg-hero bg-cover bg-center py-40 relative overflow-hidden h-[130vh] xl:h-screen">
          <div className="container flex items-center justify-center gap-y-[50px] gap-x-[100px] flex-wrap h-[400px] mx-auto">
            <div className="flex items-center">
              ...
              {/* SusTrack */}
              <div>
                <h1 className="text-lightblue font-bold text-[60px] sm:text-[100px] md:text-[120px]
                drop-shadow-[3px_3px_0px_rgba(0,0,0,0.75)] sm:drop-shadow-[4px_4px_0px_rgba(0,0,0,0.75)]
                TitleAnimation">
                  SusTrack
                </h1>
                <p className="text-l sm:text-xl text-navy font-bold SubAnimation ">Public SDGs Activity Monitoring Platform</p>
              </div>
            </div>
            {/* Box */}
            <div className="bg-gray-50/70 w-[400px] h-[320px] text-center rounded-2xl flex-col shadow-xl RaiseAnimation">
              ...
              <Link to="/map" className="block bg-navy text-white rounded-full w-[300px] mx-auto py-2 hover:bg-blue-900 transition-all ease-linear hover:scale-105">
                ดูแผนที่กิจกรรม SDGs
              </Link>
              <p className="py-2">หรือ</p>
              <Link to="/result" className="block bg-navy text-white rounded-full w-[300px] mx-auto py-2  hover:bg-blue-900 transition-all ease-linear hover:scale-105">
